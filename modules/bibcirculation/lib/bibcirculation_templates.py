...
onClick="location.href='%s/admin2/bibcirculation/create_loan?ln=%s&request_id=%s&recid=%s&borrower_id=%s'"
    ...
    def tmpl_loan_period_calculate(self, infos, ln=CFG_SITE_LANG):
        ...
        <table class="bibcirctable">
          <tr align="center">
            <td class="bibcirctableheader">Calculate Loan Period
              <br />
              <br />
            </td>
          </tr>
          <tr align="center">
          <td> <b>Start Date :</b>(Format : 2014-01-01 00:00:00) <input type="text" size="20" name="s" style='border: 1px solid #cfcfcf'> </td>
                             </tr>

        <tr align="center">
          <td><b>End Date :</b>(Format : 2015-06-01 09:00:01) <input type="text" size="20" name="e" style='border: 1px solid #cfcfcf'></td> 
                             </tr>
        <tr align="center">
          <td><b>Number of Top Results :</b>(Format : 10) <input type="text" size="20" name="n" style='border: 1px solid #cfcfcf'></td>
                             </tr>
    ...
    def tmpl_loan_period_result(self, result, ln=CFG_SITE_LANG):
	 ...
	 _("Loan Period(in days)"), _("Item List"), 
            ...
            for recid in result:
                ...
                (volume, loanPeriod, itemList, noOfItems, recordNo) = recid       
